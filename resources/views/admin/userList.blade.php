                ...
                <div class="page-rightheader ms-auto d-lg-flex d-none">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)" class="d-flex">
                            ...
                            <span class="breadcrumb-icon"> User List</span></a></li>
                    </ol>
                </div>
            </div>
            <!--End Page header-->
                        ...
                        <div class="col-12 mb-3">
                            <div class="e-panel card">
                                <div class="card-body pb-2">
                                    <div class="row">
                                        <div class="col mb-4">
                                            <a href="{{route('admin.adduserView')}}" class="btn btn-primary">
                                            ...
                                            <div class="col-xxl-3 col-xl-4 col-md-6">
                                                <div class="card border p-0 shadow-none" @if (!$user_data['is_active']) style="background: #ff000021;" @endif>
                                                    <div class="d-flex align-items-center p-4">
                                                        <div class="avatar avatar-lg brround d-block cover-image" data-image-src="{{asset($user_data['profile_picture'])}}">
                                                        </div>
