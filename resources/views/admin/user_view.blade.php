@extends('layouts.admin', ['title'=> 'Profile', 'active'=> 'user'])
@section('content')
            ...
            <div class="container-fluid main-container">
                    ...
                    <div class="page-rightheader ms-auto d-lg-flex d-none">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)" class="d-flex">
                                ...
                                <span class="breadcrumb-icon"> Profile</span></a>
                            </li>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-5">
                        @include('admin.widgets.users.view_image')
                    </div>
                    <div class="col-xl-8 col-lg-7">
                        @include('admin.widgets.users.view_profileinfo')
                    </div>
                </div>
                <!-- End Row-->
            </div>
