@extends('layouts.admin', ['title'=> 'Update announcement', 'active'=> 'announcement'])
@section('content')
            ...
            <div class="container-fluid main-container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title">Update announcement</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        @include('admin.widgets.announcement.update_announcement_info')
                    </div>
                </div>
                <!-- End Row-->
