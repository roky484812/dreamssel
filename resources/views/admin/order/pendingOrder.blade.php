@extends('layouts.admin', ['title' => 'Order Management | Pending Order', 'active' => 'pending_order'])
@section('content')
                    ...
                    <div class="page-rightheader ms-auto d-lg-flex d-none">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)" class="d-flex">
                                    ...
                                    <span class="breadcrumb-icon"> Pending Orders</span></a></li>
                        </ol>
                    </div>
                </div>
                <!--End Page header-->
                                                ...
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="card border p-0 shadow-none">
                                                        ...
                                                        <div class="card-footer">
                                                            ...
                                                            <form
                                                                action="{{ route('admin.order.confrim', ['order_id' => $order->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                <button type="submit"
                                                                    class="btn btn-primary bg-green-dark border-0 btn-sm">Order
                                                                    Confirm</button>
                                                            </form>


                                                            <form
                                                                action="{{ route('admin.order.cancel', ['order_id' => $order->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                <button type="submit"
