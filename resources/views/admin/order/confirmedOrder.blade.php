@extends('layouts.admin', ['title' => 'Order Management | Confirmed Order', 'active' => 'confirmed_order'])
@section('content')
            ...
            <div class="container-fluid main-container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title">Confirmed Order List</h4>
                    </div>
                    <div class="page-rightheader ms-auto d-lg-flex d-none">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)" class="d-flex">
                                    ...
                                    <span class="breadcrumb-icon"> Confirmed Orders</span></a></li>
                        </ol>
                    </div>
                </div>
                <!--End Page header-->
                                                    ...
                                                    <div class="col-xl-4 col-md-6">
                                                        <div class="card border p-0 shadow-none">
                                                            ...
                                                            <div class="card-footer">
                                                                ...
                                                                <form action="{{ route('admin.order.cancel', ['order_id' => $order->id]) }}" method="POST">
                                                                    @csrf
