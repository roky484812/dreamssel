<form class="card" action="{{route('admin.announcement.add')}}" method="POST">
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <input type="text" id="title" name="title" class="form-control @error('title') is-invalid  @enderror" placeholder="Announcement Title">
            @error('title')
        ...
        <div class="mb-3">
            ...
            <textarea name="short_description" id="short_description" rows="3" placeholder="Short Description" class="form-control @error('short_description') is-invalid @enderror"></textarea>
