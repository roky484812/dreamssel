                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)" class="d-flex">
                                <svg class="side-menu__icon" width="24" height="24" viewBox="0 0 40 40" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="2.5"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="attribute-input-wrapper hide-attribute-selection mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-3">
                                            <select class="form-control tag-management select2"
