                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col mb-lg-4 mb-xl-0">
                                        ...
                                        <span class="text-primary"><i class="fa fa-arrow-up me-1"></i>
                                            +1.4%</span>
                                    </div>
                                    <div class="col col-auto">
                                        <div class="mx-auto chart-circle chart-circle-md chart-circle-primary mt-sm-0 mb-0"
                                            id="chart-circle-primary" data-value="0.85" data-thickness="12"
                                            data-color="">
                ...
                <div class="row row-deck">
                    <div class="col-xl-8 col-md-12 col-lg-7">
                        <div class="card">
                                ...
                                <div class="d-flex ms-auto">
                                    <div class="btn-group mb-0">
                                        <button type="button" class="btn btn-white dropdown-toggle"
                                            data-bs-toggle="dropdown" aria-expanded="false">This Year</button>
                            ...
                            <div class="card-body">
                                <div id="projectTracked" class="h-300 overflow-hidden"></div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-sm-4 mb-4 mb-sm-0 text-center">
                                        ...
                                        <div class="text-muted mb-1 fs-13 d-inline-flex">
                                            <div class="w-3 h-3 bg-primary me-2 mt-1 br-3"></div> Project In
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-sm-4 mb-4 mb-sm-0 text-center">
                                        <h2 class="font-weight-normal text-dark mb-0">3,785</h2>
                                        <div class="text-muted mb-1 fs-13 d-inline-flex">
                                            <div class="w-3 h-3 bg-secondary me-2 mt-1 br-3"></div> Project Take
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-sm-4 text-center">
                                        <h2 class="font-weight-normal text-dark mb-0">16,897</h2>
                                        <div class="text-muted mb-1 fs-13 d-inline-flex">
                                            <div class="w-3 h-3 bg-light-color me-2 mt-1 br-3"></div> On Hold
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-0">
                                <table class="table table-hover mb-0">
                                    <tbody>
                                        ...
                                        <tr class="border-bottom">
                                            <td class="p-3 d-flex">
                                                <div class="w-3 h-3 bg-secondary me-2 mt-1 brround"></div>
                                                Shortlisted
                                            </td>
                                        ...
                                        <tr class="border-bottom">
                                            <td class="p-3 d-flex">
                                                <div class="w-3 h-3 bg-success me-2 mt-1 brround"></div>
                                                Rejected
                                            </td>
                                        ...
                                        <tr class="border-bottom">
                                            <td class="p-3 d-flex">
                                                <div class="w-3 h-3 bg-info me-2 mt-1 brround"></div> On Hold
                                            </td>
                                        ...
                                        <tr class="border-bottom">
                                            <td class="p-3 d-flex">
                                                <div class="w-3 h-3 bg-warning me-2 mt-1 brround"></div>
                                                Finalised
                                            </td>
                                            <td class="p-3">897</td>
                                            <td class="p-3">27%</td>
                                    ...
                                    <table class="table table-vcenter text-nowrap mb-0 border">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="d-flex">
                                                    ...
                                                    <div class="ms-3 mt-2">
                                                        ...
                                                        <p class="mb-0  fs-13 text-muted">lillianblake@gmail.com
                                                        </p>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="mx-auto chart-circle chart-circle-xs chart-circle-secondary mt-sm-0 mb-0 icon-dropshadow-secondary"
                                                        data-value="0.45" data-thickness="5"
                                                        data-color="#f72d66">
                                                ...
                                                <td class="text-end"><a class="btn btn-light"
                                                        href="javascript:void(0)"> View Details</a></td>
                                            </tr>
                                            <tr>
                                                <td class="d-flex">
                                                    <img class="avatar-lg rounded-circle me-3"
                                                    ...
                                                    <div class="ms-3 mt-2">
                                                        ...
                                                        <p class="mb-0  fs-13 text-muted">
                                                            georgineearle@gmail.com</p>
                                                    </div>
                                                </td>
                                                <td class="text-center">Php Developer</td>
                                                <td class="text-center">342</td>
                                                <td>
                                                    <div class="mx-auto chart-circle chart-circle-xs chart-circle-primary mt-sm-0 mb-0 icon-dropshadow-primary"
                                                        id="chart-circle-primary1" data-value="0.55"
                                                        data-thickness="5" data-color="">
                                                        <div class="mx-auto chart-circle-value text-center">55%
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end"><a class="btn btn-light"
                                            ...
                                            <tr>
                                                <td class="d-flex">
                                                    ...
                                                    <div class="ms-3 mt-2">
                                                        ...
                                                        <p class="mb-0  fs-13 text-muted">vetawillson@gmail.com
                                                        </p>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="mx-auto chart-circle chart-circle-xs chart-circle-success mt-sm-0 mb-0 icon-dropshadow-success"
                                                        data-value="0.85" data-thickness="5"
                                                        data-color="#2dce89">
                                                        <div class="mx-auto chart-circle-value text-center">85%
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end"><a class="btn btn-light"
                                            ...
                                            <tr>
                                                <td class="d-flex">
                                                    ...
                                                    <div class="ms-3 mt-2">
                                                        ...
                                                        <p class="mb-0  fs-13 text-muted">
                                                            kayleighthroneberry@gmail.com</p>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="mx-auto chart-circle chart-circle-xs chart-circle-success mt-sm-0 mb-0 icon-dropshadow-success"
                                                        data-value="0.90" data-thickness="5"
                                                        data-color="#2dce89">
                                                        <div class="mx-auto chart-circle-value text-center">90%
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end"><a class="btn btn-light"
                                            ...
                                            <tr>
                                                <td class="d-flex">
                                                    ...
                                                    <div class="ms-3 mt-2">
                                                        ...
                                                        <p class="mb-0  fs-13 text-muted">grettaperro@gmail.com
                                                        </p>
                                                    </div>
                                                </td>
                                                <td class="text-center">Angular Developer</td>
                                                ...
                                                <td>
                                                    <div class="mx-auto chart-circle chart-circle-xs chart-circle-primary mt-sm-0 mb-0 icon-dropshadow-primary"
                                                        id="chart-circle-primary2" data-value="0.65"
                                                        data-thickness="5" data-color="">
                                                        <div class="mx-auto chart-circle-value text-center">65%
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end"><a class="btn btn-light"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="mx-auto chart-circle chart-circle-xs chart-circle-secondary mt-sm-0 mb-0 icon-dropshadow-secondary"
                                                        data-value="0.40" data-thickness="5"
                                                        data-color="#f72d66">
                                                        <div class="mx-auto chart-circle-value text-center">40%
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end"><a class="btn btn-light"
                                            ...
                                            <tr>
                                                <td class="d-flex">
                                                    ...
                                                    <div class="ms-3 mt-2">
                                                        ...
                                                        <p class="mb-0  fs-13 text-muted">marleensohn@gmail.com
                                                        </p>
                                                    </div>
                                                </td>
                                                <td class="text-center">Web Designer</td>
                                                ...
                                                <td class="text-center">
                                                    <div class="mx-auto chart-circle chart-circle-xs chart-circle-primary mt-sm-0 mb-0 icon-dropshadow-primary"
                                                        id="chart-circle-primary3" data-value="0.65"
                                                        data-thickness="5" data-color="">
                                                        <div class="mx-auto chart-circle-value text-center">65%
                                                        </div>
                                                    </div>
