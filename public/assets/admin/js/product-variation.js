...
$(document).ready(function() {
    ...
    function updateAttributes() {
        ...
        $('.select2-selection__choice').each(function() {
            ...
            $('.tag-management').val($('.tag-management').val().filter(function(value) {
    ...
    function generateHTML() {
        ...
        for (var i = 0; i < attributes.length; i++) {
            ...
            html += '    </div>';
            html += '    <input id="tagInput-attr-value-' + (i + 1) + '" type="text" class="form-control attribute-value" placeholder="' + attributes[i] + ' Values with Comma (,)">';
...
// Generate HTML for each combination
    ...
    if (atLeastOneInputFilled()) {
        console.log('At least one input field with class "attribute-value" is filled.');
    } else {
    ...
    function generateProductDetailsHTML(combination) {
        ...
        productDetailsHTML += '    <input id="tagInput" type="number" class="form-control mb-1" placeholder="Stock">';
        productDetailsHTML += '    </div>';
        productDetailsHTML += '    <div class="col-sm-4">';
        productDetailsHTML += '    <input id="tagInput" type="number" class="form-control mb-1" placeholder="Regular Price">';
        productDetailsHTML += '    </div>';
        productDetailsHTML += '    <div class="col-sm-4">';
        productDetailsHTML += '    <input id="tagInput" type="number" class="form-control mb-1" placeholder="Distributor Price">';
        productDetailsHTML += '    </div>';
        productDetailsHTML += '    </div>';
